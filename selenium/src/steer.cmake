...
SET(SELENIUM_SERVER_PORT "$ENV{SELENIUM_SERVER_PORT}")
IF (NOT "${SELENIUM_SERVER_PORT}")
    SET(SELENIUM_SERVER_PORT "4444")
ENDIF()
...
MACRO(ADD_OUTPUT_FOR_BROWSERS testSuiteName testRole suiteFile)
	...
	FILE(APPEND ${CTESTTEST_CMAKE} "ADD_TEST(\"${testSuiteName}.${testRole}.${browser}\" ${SELENIUM_SERVER_CMD} ${SELENIUM_SERVER_ARG} -log ${RESULT_DIR}/${testSuiteName}.${testRole}.${browser}.${TEST_LOGFILE_POSTFIX} -htmlsuite \"${BROWSER_STR}\" ${BASE_URL}  ${suiteFile} ${RESULT_DIR}/${testSuiteName}.${testRole}.${browser}.html)\n")
    ENDFOREACH()
ENDMACRO()
